...
public class ReminderController {
	...
	public ResponseEntity<?>addReminder(@RequestBody Reminder reminder,HttpSession session){
			...
			try {
				if(service.createReminder(reminder) != null)
	...
	public ResponseEntity<?>deleteReminder(@PathVariable String id,HttpSession session){
	...
	public ResponseEntity<?> update(@PathVariable String id,@RequestBody Reminder reminder, HttpSession session) {
		try {
				if(service.updateReminder(reminder, id)!=null) {
    ...
    public ResponseEntity<?> getReminderById(@PathVariable String id) {
			...
			Reminder reminder;
			try {
				reminder = service.getReminderById(id);
				if (reminder !=null) {
					return new ResponseEntity<Reminder>(reminder, HttpStatus.OK);
				} else {
					return new ResponseEntity<Reminder>(reminder, HttpStatus.NOT_FOUND);
	...
	public ResponseEntity<?> getAllReminders(){
		...
		if (allReminders!=null) {
			return new ResponseEntity<List<Reminder>>(allReminders, HttpStatus.OK);
		} else {
			return new ResponseEntity<List<Reminder>>(allReminders, HttpStatus.NOT_FOUND);
		}
	//	return null;
	}
}
