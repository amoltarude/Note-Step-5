...
public class LoggingAspect {
	...
	@AfterThrowing(pointcut = "execution(* com.stackroute.keepnote.controller.CategoryController.*(..))",
			throwing="exception")
	...
	@AfterReturning(pointcut = "execution(* com.stackroute.keepnote.controller.CategoryController.*(..))",
			returning="val")
