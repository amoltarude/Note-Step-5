...
public class LoggingAspect {
	...
	@AfterThrowing(pointcut = "execution(* com.stackroute.keepnote.controller.NoteController.*(..))",
			throwing="exception")
	...
	@AfterReturning(pointcut = "execution(* com.stackroute.keepnote.controller.NoteController.*(..))",
			returning="val")
